...
- создание стоп листов и не только на основании наличия ингредиентов
- поиск блюд, содержащих ингредиент по ингредиенту или нескольким
- поиск технологической карты по названию блюда

### 1. Работа с ботом: После запуска бота у пользователя появляется три команды:
...
### 2. База данных блюд: Данная база данных содержит в себе три основные таблицы: блюда, блюда для бота, список ингредиентов.
